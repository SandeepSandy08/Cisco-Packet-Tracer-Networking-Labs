...
A practical collection of Cisco networking labs created using **Cisco Packet Tracer**.
...
│   ├── Task-06-Static-Routing.txt
│   ├── Task-07-Default-Route.txt
│   ├── Task-08-DHCP.txt
│   ├── Task-09-DNS.txt
│   └── Task-10-Troubleshooting.txt
│
├── Labs/
│   ├── README.md
│   ├── Task-01-Router.pkt
│   ├── Task-02-Switch.pkt
│   ├── Task-03-VLAN.pkt
│   ├── Task-04-Inter-VLAN-Routing.pkt
│   ├── Task-05-Port-Security.pkt
│   ├── Task-06-Static-Routing.pkt
│   ├── Task-07-Default-Route.pkt
│   ├── Task-08-DHCP.pkt
│   ├── Task-09-DNS.pkt
│   └── Task-10-Troubleshooting.pkt
│
└── Documentation/
    └── Cisco-Packet-Tracer-Network-Labs.pdf
